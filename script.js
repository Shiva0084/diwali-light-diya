(() => {
	...
	const quotes = [
		...
		"Wishing you a festival full of sweet memories and bright moments.",
		"Light a lamp of love, blast a chain of sorrow, shoot a rocket of prosperity!",
		"Diwali is the festival of lights, but it also brings peace, joy, and hope.",
		"Let the light of Diya guide you on the way to happiness and success.",
		"Celebrate Diwali with a heart full of joy and a mind full of peace.",
		"May the divine light of Diwali spread into your life happiness, peace, and prosperity.",
		"Diwali is not just about lights and crackers, it's about hope, positivity and love.",
		"As you light each diya, may you brighten someone else's life too."
	];
